function TermsOfService() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Music Discovery.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Music Discovery, accessible from{" "}
            <a
              href="https://18.116.235.243/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://18.116.235.243/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mitchell.ramos1028@gmail.com</li>
      </ul>
    </>
  );
}
